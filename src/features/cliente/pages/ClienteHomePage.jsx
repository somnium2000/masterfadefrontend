...
export default function ClienteHomePage() {
    ...
    const mobileItems = [
        { id: 'inicio', label: 'Inicio', icon: House, onClick: () => navigate('/home/cliente') },
                ...
                <main className="mt-10 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        <PlaceholderCard
                            icon={CalendarDays}
                            title="Agendar Cita"
                            subtitle="Reserva tu próxima visita a la barbería"
                        />
                        <PlaceholderCard
                            icon={ClipboardList}
                            title="Mis Citas"
                            subtitle="Historial y citas pendientes"
                        />
                        <PlaceholderCard
                            icon={User}
                            title="Mi Perfil"
                        ...
                        <PlaceholderCard
                            icon={Scissors}
                            title="Ver Servicios"
                            subtitle="Explora el catálogo premium"
                            disabled={false}
                        />
                    </div>
                </main>
